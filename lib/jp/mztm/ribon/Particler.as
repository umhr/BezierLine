    ...
    internal class Particler extends Sprite
    {
		...
		public function execute(mouseX:Number = 0, mouseY:Number = 0):void {
            ...
            for (var i:int = 0; i < n; i++) {
                ...
                var r:Number = 5 * (0.3 + 1 * Math.sin(_count / 12));
        ...
        private function draw(mousePoint:Vector.<Vector.<Point>>):void {
            ...
            for (var i:int = 0; i < n; i++) {
				...
				if (Math.random() > 0) {
					var element:Particle = new Particle(Particle.CROSS);
